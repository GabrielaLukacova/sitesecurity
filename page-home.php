    ...
    <div class="contact-form">
        ...
        <style>
            .wpcf7 input[type="submit"] {
                ...
                border-radius: 10px;
                cursor: pointer;
                margin-top: 10px; /* Add margin to adjust the distance from the form */
            }
...
<footer>
        ...
        <a href="https://www.sitesecurity.dk/" target="_blank">
                    <img src="<?php echo get_stylesheet_directory_uri() ?>/images/SiteSecurityLogo.png" alt="Logo" width="150" height="150">
                </a>
        </div>
